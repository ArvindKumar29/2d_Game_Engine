...
void Sandbox2D::OnUpdate(Hazle::Timestep ts)
{
...

	{
		...
		Hazle::Renderer2D::DrawQuad({ -0.5f, 0.0f }, 0.0f, glm::vec2(1.0f), { 0.8f, 0.2f, 0.1f, 1.0f });
		Hazle::Renderer2D::DrawQuad({ 1.0f, 0.2f }, 0.0f, { 0.8f, 0.6f }, { 0.3f, 0.9f, 0.1f, 1.0f });
		Hazle::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, 0.0f, { 10.0f, 10.0f }, m_CheckerboardTexture, {1.0f, 0.6f, 0.6f, 1.0f});
