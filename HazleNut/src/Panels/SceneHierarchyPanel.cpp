...
namespace Hazle
{
	...
	{	
		...
		if (ImGui::BeginPopup("AddComponent"))
		{
			...
			if(!m_SelectionContext.hasComponent<CCircleCollider2D>())
				if (ImGui::MenuItem("Circle Collider"))
				{
					m_SelectionContext.AddOrReplaceComponent<CCircleCollider2D>();
					ImGui::CloseCurrentPopup();
				}
			ImGui::EndPopup();
		...
		///CIRCLE COLLIDER
		//////////////////
		DrawComponent<CCircleCollider2D>("Circle Collider", entity, [](auto& component)
		{	
			ImGui::DragFloat2("Offset",					glm::value_ptr(component.Offset));
